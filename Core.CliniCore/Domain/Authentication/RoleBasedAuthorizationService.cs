...
namespace Core.CliniCore.Domain.Authentication
{
    ...
    public class RoleBasedAuthorizationService
    {
        ...
        {
            // Patient permissions
            _rolePermissions[UserRole.Patient] = new HashSet<Permission>
            {
            ...
            _rolePermissions[UserRole.Physician] = new HashSet<Permission>
            {
            ...
            _rolePermissions[UserRole.Administrator] = new HashSet<Permission>(
        ...
        /// </summary>
        public bool CanAccessUserData(SessionContext? session, Guid targetUserId)
        {
            if (session == null)
                return false;
        ...
        /// </summary>
        public bool ValidateSession(SessionContext? session)
        {
            if (session == null)
                return false;
